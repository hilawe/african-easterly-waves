...
component was checked line by line against the surviving original code by an independent line-by-line check. Input datasets and their access paths are recorded so that each
